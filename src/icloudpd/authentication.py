...
def authenticator(
    ...
    if icloud.requires_2fa:
        ...
        if mfa_provider == MFAProvider.WEBUI:
            request_2fa_web(icloud, logger, status_exchange, notify_mfa_accepted, notify_mfa_rejected)
        else:
